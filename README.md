...
ledgersql is a SQL project for databases. It focuses on this technical goal: Validate double-entry ledger constraints and reconciliation queries.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 155, risk penalty 7, latency penalty 2, and weight bonus 4. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
