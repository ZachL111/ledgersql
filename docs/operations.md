...
`ledgersql` is centered on databases work in SQL. The technical target is: Validate double-entry ledger constraints and reconciliation queries.
...
The score is deterministic. The current threshold is 155. Risk has a penalty of 7, latency has a penalty of 2, and weight contributes a bonus of 4.
