"""Regression checks for the ledgersql casebook."""
...
from casebook.harness import assert_expected, ledgersql_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(ledgersql_summary(), assert_expected())
